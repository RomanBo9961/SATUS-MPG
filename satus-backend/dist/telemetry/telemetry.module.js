...
const telemetry_gateway_1 = require("./gateways/telemetry/telemetry.gateway");
...
exports.TelemetryModule = TelemetryModule = __decorate([
    (0, common_1.Module)({
        providers: [telemetry_gateway_1.TelemetryGateway],
        exports: [telemetry_gateway_1.TelemetryGateway],
    })
], TelemetryModule);
